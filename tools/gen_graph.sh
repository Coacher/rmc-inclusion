...
if [ -d "$1-$2-$3" ]; then
    ...
    if [ -f "inclusion_tree_short_$1-$2-$3.gv" ]; then
        tred "inclusion_tree_short_$1-$2-$3.gv" > "inclusion_tree_short_$1-$2-$3_reduced.gv"
        dot -Tsvg "inclusion_tree_short_$1-$2-$3_reduced.gv" > "inclusion_tree_short_$1-$2-$3.svg"
    fi
